   ...
   <div class="container" id="container">
      <div class="incontainer" style="height: 1000px;">
         ...
         <div class="products">
            ...
            <h1 class="heading">MAN NIKE SHOES</h1>
            <hr>
            ...
            <div class="box-container">
               ...
               $select_product = mysqli_query($conn, "SELECT * FROM `product` WHERE gender = 'man' AND category = 'nike'") or die('query failed');
               if (mysqli_num_rows($select_product) > 0) {
                  while ($fetch_product = mysqli_fetch_assoc($select_product)) {
               ?>
                     <form method="post" class="box" action="">
                        <img src="/img/product img/nike/Men/<?php echo $fetch_product['pic']; ?>" alt="">
