   ...
   <div class="container" id="container">
      <div class="incontainer" style="height: 1000px;">
            ...
            <header>
               <nav>
                  <ul class="navLinks">
                     ...
                     <li><a href="womenShop.php">Women</a></li>
         ...
         <div class="sticky">
            <div class="inSticky">
               ...
               <li><a href="nikeMan.php" id="nike">NIKE</a></li>
                  <li><a href="pumaWoman.php" id="puma">PUMA</a></li>
                  <li><a href="skechersWoman.php" id="skecer">SKETCHERS</a></li>
         ...
         <div class="products">
            ...
            <h1 class="heading">WOMAN PUMA SHOES</h1>
            <hr>
            ...
            <div class="box-container">
               ...
               $select_product = mysqli_query($conn, "SELECT * FROM `puma` WHERE pumaGender = 'Man'") or die('query failed');
               if (mysqli_num_rows($select_product) > 0) {
                  while ($fetch_product = mysqli_fetch_assoc($select_product)) {
               ?>
                     <form method="post" class="box" action="">
                        <img src="/img/product img/Puma/Women/<?php echo $fetch_product['pumaPic']; ?>" alt="">
                        <div class="name"><?php echo $fetch_product['pumaName']; ?></div>
                        <div class="price">RM<?php echo $fetch_product['pumaPrice']; ?></div>
                        ...
                        <input type="hidden" name="product_image" value="<?php echo $fetch_product['pumaPic']; ?>">
                        <input type="hidden" name="product_name" value="<?php echo $fetch_product['pumaName']; ?>">
                        <input type="hidden" name="product_price" value="<?php echo $fetch_product['pumaPrice']; ?>">
